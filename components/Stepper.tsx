...
export const Stepper: React.FC<StepperProps> = ({ currentStep, goToStep }) => {
  return (
            ...
            {stepIdx < currentStep ? (
              <>
                ...
                >
                  ...
                  <span className="absolute -bottom-7 w-max text-xs font-semibold text-indigo-600">{step}</span>
                </button>
              </>
              ...
              <>
                ...
                <div className="group relative flex h-8 w-8 items-center justify-center rounded-full border-2 border-gray-300 bg-white hover:border-gray-400">
                  ...
                  <span className="absolute -bottom-7 w-max text-xs font-medium text-gray-500">{step}</span>
                </div>
              </>
            )}
          </li>
